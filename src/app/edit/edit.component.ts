...
export class EditComponent implements OnInit {
  ...
  onEditShow(form: NgForm) {
    ...
    this.showService.UpdateShows(this.show._id, form.value.name, form.value.desc, form.value.type, form.value.pickdate).
      subscribe();
  }  /*this updates the information from these values */
}